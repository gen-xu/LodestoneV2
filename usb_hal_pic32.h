...
#define USB_PULLUP_ENABLE 0x80
#define USB_PULLUP_DISABLE 0x84
...
#define USBDisableInterrupts() {IEC1CLR = USBIE;}
    ...
    #define SetConfigurationOptions()   {U1CNFG1 = 0;U1EIE = 0x9F;U1IE = 0x99 | USB_SOF_INTERRUPT | USB_ERROR_INTERRUPT; U1OTGCON &= 0x00FF;  U1OTGCON |= USB_PULLUP_OPTION;}
